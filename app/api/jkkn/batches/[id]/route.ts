...
/**
 * GET /api/jkkn/batches/[id]
 * Fetch a single batch by ID from JKKN API
 */
export async function GET(
  ...
  try {
    ...
    // Call JKKN API
    const url = `${baseUrl}/api-management/academic/batches/${id}`;

    console.log('[Batches API] Fetching by ID:', url);
    ...
    // Transform the data
    const transformedData = transformBatchData(data.data || data);
