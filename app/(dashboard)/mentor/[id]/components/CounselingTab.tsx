    ...
    <div>
      ...
      {students.length === 0 && (
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 text-center mb-4 lg:mb-6">
          ...
          <p className="text-[15px] font-medium text-neutral-900 mb-2">No Learners Assigned</p>
          <p className="text-[14px] text-neutral-600 leading-relaxed">
            Please assign learners first before creating counseling sessions.
          </p>
        </div>
      )}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-brand-cream p-5 rounded-xl border-2 border-brand-yellow">
            <label className="block text-base font-medium text-brand-green mb-4 flex items-center gap-2">
              ...
              Select Learners <span className="text-red-600">*</span>
            </label>
            ...
            <div className="mb-3 pb-3 border-b-2 border-brand-yellow/50">
              <label className="flex items-center gap-3 cursor-pointer hover:bg-brand-yellow/20 p-3 rounded-lg transition-all group">
                ...
                <span className="font-medium text-brand-green group-hover:text-brand-green flex items-center gap-2">
                  ...
                  Select All Learners ({students.length})
                </span>
              </label>
            </div>
              ...
              {filteredStudents.length === 0 ? (
                <div className="text-center py-12 text-neutral-500">
                  ...
                  <p className="font-medium text-brand-green mb-1">
                    {searchQuery ? 'No students found' : 'No learners assigned'}
                  </p>
