  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-[22px] font-medium text-neutral-900 tracking-tight">Manage Documents</h1>
          <p className="text-[13px] text-neutral-600 mt-1">Upload and manage mentor guide documents</p>
        </div>
